...
def model_call_for_alluint8(folder_address,img,select_layer=None):
...
def evaluate_for_alluint8(folder_address,images,labels,select_layer=None):
    accuracy_count = 0
    image_count = images.shape[0]
    use_time=0
    layer_use_counter=0
    for i in tqdm(range(image_count)):
        predict_num, use_time_def, layer_use_counter_def= model_call_for_alluint8(folder_address,images[i],select_layer)
...
if __name__=='__main__':
    ...
    full_uint8_accuracy, use_time0, layer_use_counter0 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels)
    full_uint8_accuracy_exit1, use_time1, layer_use_counter1 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,1)
    full_uint8_accuracy_exit2, use_time2, layer_use_counter2 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,2)
    full_uint8_accuracy_exit3, use_time3, layer_use_counter3 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,3)
    full_uint8_accuracy_exit4, use_time4, layer_use_counter4 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,4)
    full_uint8_accuracy_exit5, use_time5, layer_use_counter5 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,5)
    full_uint8_accuracy_exit6, use_time6, layer_use_counter6 = evaluate_for_alluint8("./TFLITE_Models/Full_Uint8_Models",test_images,test_labels,6)
    
    # 各出口準確度
    x=[1,2,3,4,5,6,7]
    y=[round((full_uint8_accuracy*100),4), round((full_uint8_accuracy_exit1*100),4), round((full_uint8_accuracy_exit2*100),4), round((full_uint8_accuracy_exit3*100),4), round((full_uint8_accuracy_exit4*100),4), round((full_uint8_accuracy_exit5*100),4), round((full_uint8_accuracy_exit6*100),4)]
    ...
    plt.title("Auto exit distribution Map")
    plt.show()
