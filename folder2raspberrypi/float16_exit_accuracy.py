...
if __name__=='__main__':
    ...
    float16_accuracy, use_time0, layer_use_counter0 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels)
    float16_accuracy_exit1, use_time1, layer_use_counter1 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,1)
    float16_accuracy_exit2, use_time2, layer_use_counter2 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,2)
    float16_accuracy_exit3, use_time3, layer_use_counter3 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,3)
    float16_accuracy_exit4, use_time4, layer_use_counter4 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,4)
    float16_accuracy_exit5, use_time5, layer_use_counter5 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,5)
    float16_accuracy_exit6, use_time6, layer_use_counter6 = evaluate("./TFLITE_Models/Float16_Models",test_images,test_labels,6)
    
    # 各出口準確度
    x=[1,2,3,4,5,6,7]
    y=[round((float16_accuracy*100),4), round((float16_accuracy_exit1*100),4), round((float16_accuracy_exit2*100),4), round((float16_accuracy_exit3*100),4), round((float16_accuracy_exit4*100),4), round((float16_accuracy_exit5*100),4), round((float16_accuracy_exit6*100),4)]
