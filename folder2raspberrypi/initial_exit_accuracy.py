...
if __name__=='__main__':
    ...
    initial_accuracy, use_time0, layer_use_counter0 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels)
    initial_accuracy_exit1, use_time1, layer_use_counter1 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,1)
    initial_accuracy_exit2, use_time2, layer_use_counter2 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,2)
    initial_accuracy_exit3, use_time3, layer_use_counter3 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,3)
    initial_accuracy_exit4, use_time4, layer_use_counter4 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,4)
    initial_accuracy_exit5, use_time5, layer_use_counter5 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,5)
    initial_accuracy_exit6, use_time6, layer_use_counter6 = evaluate("./TFLITE_Models/Initial_Models",test_images,test_labels,6)
    
    # 各出口準確度
    x=[1,2,3,4,5,6,7]
    y=[round((initial_accuracy*100),4), round((initial_accuracy_exit1*100),4), round((initial_accuracy_exit2*100),4), round((initial_accuracy_exit3*100),4), round((initial_accuracy_exit4*100),4), round((initial_accuracy_exit5*100),4), round((initial_accuracy_exit6*100),4)]
